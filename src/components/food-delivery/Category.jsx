        ...
        {categories.map((cat) => (
          ...
          >
            <img
              src={cat.image}
              alt={cat.name}
              className="w-20 h-20 md:w-30 md:h-30 object-cover rounded-full shadow-lg mx-auto"
            />
            <p className="mt-2 text-sm font-cal text-gray-600">{cat.name}</p>
          </Link>
        ))}
      </div>
    </div>
